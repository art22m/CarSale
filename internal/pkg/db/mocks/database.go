...
func (m *MockDatabaseOperations) Exec(ctx context.Context, query string, args ...interface{}) (pgconn.CommandTag, error) {
	m.ctrl.T.Helper()
...
func (mr *MockDatabaseOperationsMockRecorder) Exec(ctx, query interface{}, args ...interface{}) *gomock.Call {
...
func (m *MockDatabaseOperations) ExecQueryRow(ctx context.Context, query string, args ...interface{}) v4.Row {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, query}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (mr *MockDatabaseOperationsMockRecorder) ExecQueryRow(ctx, query interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, query}, args...)
...
func (m *MockDatabaseOperations) Get(ctx context.Context, dest interface{}, query string, args ...interface{}) error {
	m.ctrl.T.Helper()
...
func (mr *MockDatabaseOperationsMockRecorder) Get(ctx, dest, query interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockDatabaseOperations) GetPool() *pgxpool.Pool {
	m.ctrl.T.Helper()
...
func (mr *MockDatabaseOperationsMockRecorder) GetPool() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetPool", reflect.TypeOf((*MockDatabaseOperations)(nil).GetPool))
}

// Select mocks base method.
func (m *MockDatabaseOperations) Select(ctx context.Context, dest interface{}, query string, args ...interface{}) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, dest, query}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (mr *MockDatabaseOperationsMockRecorder) Select(ctx, dest, query interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, dest, query}, args...)
